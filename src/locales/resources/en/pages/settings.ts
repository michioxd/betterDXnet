const I18nSettings = {
    ...
    betterDXnet: {
        title: "Settings / betterDXnet",
        description: "Configure betterDXnet app data sources and local database.",
        maimaiDataApi: "maimai data API",
        currentDataUrl: "Current maimai data API URL",
        customDataUrl: "Custom maimai data API URL",
        customDataUrlHelper: "Use an absolute HTTP or HTTPS URL pointing to a compatible data.json file.",
        compatibilityNotice:
            "If you are using a custom data source, please ensure that it follows the same structure and format as the default data source (<formatLink>see this TypeScript file for more details</formatLink>). Please do not touch this section if you are not sure about it.",
        defaultDataUrl: "Default URL",
        dataSourceFrom: "Data source from",
        invalidUrl: "Enter a valid HTTP or HTTPS URL.",
        dataUrlSaved: "maimai data API URL saved.",
        dataUrlReset: "maimai data API URL reset to default.",
        database: "Database",
        databaseDescription: "Force download data from the current API URL.",
        lastFetchedAt: "Last fetched at",
        dataUpdateTime: "Database update time",
        notAvailable: "Not available",
        reupdateDatabase: "Reupdate database",
